...
internal actual value class Strings actual constructor(actual val value: Int) {
    actual companion object {
        actual val Cut: Strings = Strings(0)
        actual val Copy: Strings = Strings(1)
        actual val Paste: Strings = Strings(2)
        actual val SelectAll: Strings = Strings(3)
        actual val Autofill: Strings = Strings(4)
    }
}
...
internal actual value class Icons actual constructor(actual val value: Int) {
    actual companion object {
        actual val ActionModeCutDrawable = Icons(0)
        actual val ActionModeCopyDrawable = Icons(1)
        actual val ActionModePasteDrawable = Icons(2)
        actual val ActionModeSelectAllDrawable = Icons(3)
        actual val ID_NULL = Icons(-1)
    }
}