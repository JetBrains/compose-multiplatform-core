...
class Scrollable2DTest {
    ...
    private fun ComposeContentTestRule.setContentAndGetScope(content: @Composable NoriaContext.() -> Unit) {
        setContent {
    ...
    private fun setScrollable2DContent(scrollableModifierFactory: @Composable NoriaContext.() -> Modifier) {
        rule.setContentAndGetScope {
            Box {
