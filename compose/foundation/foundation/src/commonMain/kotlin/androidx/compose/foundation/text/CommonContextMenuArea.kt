 ...
 */
internal enum class TextContextMenuItems(val key: Any, val stringId: Strings, val drawableId: Icons) {
    Cut(
        key = TextContextMenuKeys.CutKey,
        stringId = Strings.Cut,
        drawableId = Icons.ActionModeCutDrawable
    ),
    Copy(
        key = TextContextMenuKeys.CopyKey,
        stringId = Strings.Copy,
        drawableId = Icons.ActionModeCopyDrawable
    ),
    Paste(
        key = TextContextMenuKeys.PasteKey,
        stringId = Strings.Paste,
        drawableId = Icons.ActionModePasteDrawable
    ),
    SelectAll(
        key = TextContextMenuKeys.SelectAllKey,
        stringId = Strings.SelectAll,
        drawableId = Icons.ActionModeSelectAllDrawable
    ),
    Autofill(
        key = TextContextMenuKeys.AutofillKey,
        stringId = Strings.Autofill,
        // Platform also doesn't have an icon for the autofill item.
        drawableId = Icons.ID_NULL
    );
