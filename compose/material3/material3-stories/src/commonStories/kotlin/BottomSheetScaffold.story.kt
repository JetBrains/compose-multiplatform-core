...
val `BottomSheetScaffold Story` by story {
    ...
    val useCustomSheetColors by parameter(false)
    ...
    Row(modifier = Modifier.width(rowWidthDp.dp)) {
        BottomSheetScaffold(
            ...
            sheetContainerColor = if (useCustomSheetColors) sheetContainerColor else BottomSheetDefaults.ContainerColor,
            sheetContentColor = if (useCustomSheetColors) sheetContentColor else contentColorFor(sheetContainerColor),
