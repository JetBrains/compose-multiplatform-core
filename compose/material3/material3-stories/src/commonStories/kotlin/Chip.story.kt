...
val `InputChip Story` by story {
    ...
    // Only show icon colors if corresponding icons are displayed
    ...
    Box(
        ...
        InputChip(
            ...
            trailingIcon = if (showTrailingIcon) {
                {
                    // Using FilledIconToggleButton to manage icon with ripple effect
                    FilledIconToggleButton(
                        ...
                        colors = IconButtonDefaults.filledIconToggleButtonColors(
                            ...
                            contentColor = if (useCustomColors && selected && showTrailingIcon)
...
val `FilterChip Story` by story {
    // Basic parameters
    val chipLabel by parameter("Filter Chip")
    var selected by parameter(false)
    val enabled by parameter(true)
    ...
    val selectedLeadingIconColor by parameter(Color(0xFF6750A4))
    val selectedTrailingIconColor by parameter(Color(0xFF6750A4))
    val leadingIconColor by parameter(MaterialTheme.colorScheme.onSurfaceVariant)
...
val `ElevatedFilterChip Story` by story {
    // Basic parameters
    val chipLabel by parameter("Filter Chip")
    var selected by parameter(false)
    val enabled by parameter(true)
    ...
    val selectedElevation by parameter(3f)
...
val `ElevatedSuggestionChip Story` by story {
    // Basic parameters
    val chipLabel by parameter("Suggestion Chip")
    val enabled by parameter(true)
    ...
    val disabledLabelColor by parameter(Color.Gray.copy(alpha = 0.38f))
    val disabledIconColor by parameter(Color.Gray.copy(alpha = 0.38f))
    ...
    val colors = if (useCustomColors) {
        SuggestionChipDefaults.elevatedSuggestionChipColors(
            ...
            disabledIconContentColor = disabledIconColor
        )
    } else {
        SuggestionChipDefaults.elevatedSuggestionChipColors()
    }
