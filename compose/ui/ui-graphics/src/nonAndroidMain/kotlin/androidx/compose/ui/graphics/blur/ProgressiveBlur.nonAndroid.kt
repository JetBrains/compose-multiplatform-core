...
// TODO(Merge) Major, Implement progressive blur effects for non-Android targets. Without this,
// progressive blur is a no-op on desktop and web.
private fun stubProgressiveBlurEffect(
    spec: BlurRadiusSpec,
    size: Size,
    density: Density,
    edgeTreatment: TileMode,
): RenderEffect = BlurEffect(null, 0f, 0f, edgeTreatment)
