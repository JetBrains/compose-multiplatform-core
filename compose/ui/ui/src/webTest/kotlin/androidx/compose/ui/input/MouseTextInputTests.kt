...
class MouseTextInputTests: OnCanvasTests {
    ...
    fun canSelectUsingMouse() = runApplicationTest {
        ...
        yield()
        canvas.dispatchEvent(PointerEvent("pointerdown", PointerEventInit(clientX = 8, clientY = 20, buttons = 1, button = 1)))
        yield()
        canvas.dispatchEvent(PointerEvent("pointerup", PointerEventInit(clientX = 8, clientY = 20, buttons = 0, button = 1)))
        ...
        canvas.dispatchEvent(PointerEvent("pointermove", PointerEventInit(clientX = startX, clientY = startY, buttons = 1, button = 1)))
        canvas.dispatchEvent(PointerEvent("pointerdown", PointerEventInit(clientX = startX, clientY = startY, buttons = 1, button = 1)))
        canvas.dispatchEvent(PointerEvent("pointermove", PointerEventInit(clientX = endX, clientY = startY, buttons = 1, button = 1)))
        canvas.dispatchEvent(PointerEvent("pointerup", PointerEventInit(clientX = endX, clientY = startY, buttons = 0, button = 1)))
