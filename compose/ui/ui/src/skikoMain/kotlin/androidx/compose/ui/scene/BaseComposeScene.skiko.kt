...
internal abstract class BaseComposeScene(
    ...
    private val invalidate: (onNextFrame: Boolean) -> Unit,
) : ComposeScene {
    ...
    private val frameClock = BroadcastFrameClock(
        onNewAwaiters = { updateInvalidations(onNextFrame = true) }
    )
    ...
    protected fun updateInvalidations(onNextFrame: Boolean = false) {
